                    ...
                    <form role="form" action="{{route('admin.blogs.update',$blog->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="author" id="author" placeholder="Enter Author Name" value="{{$blog->author}}" required>
                            </div>
                            <div class="form-group">
                                <img src="{{url($blog->image)}}" alt="" width="80" height="60">
